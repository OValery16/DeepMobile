...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/activate/ActivationForwardGpuNaive.cpp: ~ActivationForwardGpuNaive");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/activate/ActivationForwardGpuNaive.cpp: forward");
#endif
...
ActivationForwardGpuNaive::ActivationForwardGpuNaive(EasyCL *cl, int numPlanes, int inputSize, ActivationFunction const*fn) :
    ...
    "\n"
    "";
    kernel = cl->buildKernelFromString("ActivationForwardGpuNaive", kernelSource, "forwardNaive", options, "cl/activate.cl");
    // [[[end]]]
}
