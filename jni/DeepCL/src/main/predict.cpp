...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/main/predict.cpp: loadConfigString(config.weightsFile, netDef) ){");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/main/predict.cpp: createNetFromNetdef(net, netDef, weightsInitializer) ) {");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/main/predict.cpp: loadWeights(config.weightsFile, string("netDef=")+netDef, net, &ignI, &ignI, &ignF, &ignI, &ignF) ){");
#endif
