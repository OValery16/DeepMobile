...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/pooling/PoolingForwardGpuNaive.cpp: ~PoolingForwardGpuNaive");
#endif
...
LOGI( "DeepCL/src/pooling/PoolingForwardGpuNaive.cpp: forward");
#endif
...
PoolingForwardGpuNaive::PoolingForwardGpuNaive(EasyCL *cl, bool padZeros, int numPlanes, int inputSize, int poolingSize) :
    ...
    "\n"
    "";
    kernel = cl->buildKernelFromString("PoolingForwardGpuNaive", kernelSource, "forwardNaive", options, "cl/pooling.cl");
    // [[[end]]]
