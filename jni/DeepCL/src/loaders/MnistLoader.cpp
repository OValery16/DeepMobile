...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/loaders/MnistLoader.cpp: load");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/loaders/MnistLoader.cpp: loadLabels");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/loaders/MnistLoader.cpp: readUInt");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/loaders/MnistLoader.cpp: writeUInt");
#endif
