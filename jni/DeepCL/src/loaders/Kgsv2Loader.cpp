...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/loaders/Kgsv2Loader.cpp: getDimensions");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/loaders/Kgsv2Loader.cpp: load");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/loaders/Kgsv2Loader.cpp: getRecordSize");
#endif
