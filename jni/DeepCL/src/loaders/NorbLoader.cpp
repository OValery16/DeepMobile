...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/loaders/NorbLoader.cpp: getDimensions");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/loaders/NorbLoader.cpp: load");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/loaders/NorbLoader.cpp: loadLabels");
#endif
...
STATIC unsigned char *NorbLoader::loadImages(std::string filepath, int *p_N, int *p_numPlanes, int *p_imageSize) {
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/loaders/NorbLoader.cpp: loadImages");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/loaders/NorbLoader.cpp: writeImages");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/loaders/NorbLoader.cpp: writeLabels");
#endif
