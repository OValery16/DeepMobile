...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/CopyBuffer.cpp: copy");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/CopyBuffer.cpp: ~CopyBuffer");
#endif
...
//    cout << "CopyBuffer: building kernel" << endl;
    ...
    "\n"
    "";
    kernel = cl->buildKernelFromString("CopyBuffer", kernelSource, "copy", options, "cl/copy.cl");
    // [[[end]]]
