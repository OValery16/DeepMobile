...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/GpuAdd.cpp: add");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/GpuAdd.cpp: ~GpuAdd");
#endif
...
//    cout << "GpuAdd: building kernel" << endl;
    ...
    "\n"
    "";
    kernel = cl->buildKernelFromString("GpuAdd", kernelSource, "per_element_add", options, "cl/per_element_add.cl");
    // [[[end]]]
