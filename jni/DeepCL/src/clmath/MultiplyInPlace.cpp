...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/MultiplyInPlace.cpp: multiply");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/MultiplyInPlace.cpp: ~MultiplyInPlace");
#endif
...
//        cout << "MultiplyInPlace kernel already built => reusing" << endl;
    ...
    "\n"
    "";
    kernel = cl->buildKernelFromString("MultiplyInPlace", kernelSource, "multiplyInplace", options, "cl/copy.cl");
    // [[[end]]]
