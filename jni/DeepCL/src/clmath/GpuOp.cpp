...
#include "GpuOp.h"
#include "../../EasyCL/templates/LuaTemplater.h"
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/GpuOp.cpp: apply2_inplace");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/GpuOp.cpp: apply2_outofplace");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/GpuOp.cpp: apply1_inplace");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/GpuOp.cpp: apply1_outofplace");
#endif
...
VIRTUAL GpuOp::~GpuOp() {
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/GpuOp.cpp: ~GpuOp");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/GpuOp.cpp: buildKernel");
#endif
    ...
    string operation="GpuOp0"+op->getName();
    string clKernelName = "per_element_op2_outofplace";
    if(inPlace) {
        clKernelName = "per_element_op2_inplace";
        operation=operation+"_inplace";
    }else
    	operation=operation+"_outofplace";

    kernel = cl->buildKernelFromString(operation/*"GpuOp0"*/, renderedKernel, clKernelName, "", "cl/per_element_op2.cl");
...
LOGI( "DeepCL/src/clmath/GpuOp.cpp: buildKernel");
    ...
    // cout << "renderedKernel:" << endl;
    // cout << renderedKernel << endl;
    string operation="GpuOp1"+op->getName();
    ...
    kernel = cl->buildKernelFromString(operation/*"GpuOp1"*/, renderedKernel, clKernelName, "", "cl/per_element_op1.cl");
    cl->storeKernel(name, kernel, true);
}
void GpuOp::buildKernelScalar(std::string name, Op2 *op, bool inPlace) {
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/GpuOp.cpp: buildKernelScalar");
#endif
    ...
    // cout << "renderedKernel:" << endl;
    // cout << renderedKernel << endl;
    string operation="GpuOp2"+op->getName();
    string clKernelName = "per_element_op2_outofplace";
    if(inPlace) {
        clKernelName = "per_element_op2_inplace";
        operation=operation+"_inplace";
    ...
    kernel = cl->buildKernelFromString(operation/*"GpuOp2"*/, renderedKernel, clKernelName, "", "cl/per_element_op2_scalar.cl");
    cl->storeKernel(name, kernel, true);
}
