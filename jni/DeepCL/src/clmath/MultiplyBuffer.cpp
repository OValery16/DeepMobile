...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/MultiplyBuffer.cpp: multiply");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/clmath/MultiplyBuffer.cpp: ~MultiplyBuffer");
#endif
...
//    options += " -DgMultiplier=" + floatToFloatString(multiplier);
    ...
    "\n"
    "";
    kernel = cl->buildKernelFromString("MultiplyBuffer", kernelSource, "multiplyConstant", options, "cl/copy.cl");
    // [[[end]]]
