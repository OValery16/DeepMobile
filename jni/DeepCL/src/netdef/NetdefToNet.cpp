...
//		   layerDef3=splitConfigNetDef[i+1];
		   ...
		   createDropout(batchsize,net, layerDef, weightsInitializer);
		   ...
		   createRandomTranslation(batchsize,net, layerDef, weightsInitializer);
    ...
    net->addLayer(SoftMaxMaker::instance(false));
    return true;
}
...
STATIC bool NetdefToNet::createNetFromNetdefPrediction(int batchsize, NeuralNet *net, std::string netdef, WeightsInitializer *weightsInitializer) {
    ...
    net->addLayer(SoftMaxMaker::instance(true));
    return true;
}
...
void NetdefToNet::createDropout(int batchsize,NeuralNet *net, std::string layerDef, WeightsInitializer *weightsInitializer) {
...
void NetdefToNet::createRandomTranslation(int batchsize,NeuralNet *net, std::string layerDef, WeightsInitializer *weightsInitializer) {
...
void NetdefToNet::createFullyConnectedLayer(int batchsize,NeuralNet *net, std::string layerDef, std::string activation_layerDef,  WeightsInitializer *weightsInitializer) {
