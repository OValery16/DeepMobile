...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/trainers/Adadelta.cpp: ~Adadelta");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/trainers/Adadelta.cpp: string Adadelta::asString");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/trainers/Adadelta.cpp: bindState");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/trainers/Adadelta.cpp: instance");
#endif
