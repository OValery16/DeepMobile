...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/trainers/Adagrad.cpp: ~Adagrad");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/trainers/Adagrad.cpp: setFudgeFactor");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/trainers/Adagrad.cpp: string Adagrad::asString");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/trainers/Adagrad.cpp: bindState");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/trainers/Adagrad.cpp: instance");
#endif
