...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/trainers/Rmsprop.cpp: ~Rmsprop");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/trainers/Rmsprop.cpp: string Rmsprop::asString");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/trainers/Rmsprop.cpp: bindState");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/trainers/Rmsprop.cpp: instance");
#endif
