...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/conv/unused/ForwardFc_workgroupPerFilterPlane.cpp: ~ForwardFc_workgroupPerFilterPlane");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/conv/unused/ForwardFc_workgroupPerFilterPlane.cpp: forward");
#endif
...
ForwardFc_workgroupPerFilterPlane::ForwardFc_workgroupPerFilterPlane(EasyCL *cl, LayerDimensions dim) :
    ...
    "\n" 
    "";
    kernel1 = cl->buildKernelFromString("ForwardFc_workgroupPerFilterPlane", kernel1Source, "forward_fc_workgroup_perrow", options, "cl/forward_fc_wgperrow.cl");
    ...
    "\n" 
    "";
    kernel2 = cl->buildKernelFromString("ForwardFc_workgroupPerFilterPlane", kernel2Source, "reduce_rows", options, "cl/forward_fc.cl");
    // [[[end]]]
}
