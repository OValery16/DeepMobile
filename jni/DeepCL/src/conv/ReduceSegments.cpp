...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/conv/ReduceSegments.cpp: ~ReduceSegments");
#endif
...
ReduceSegments::ReduceSegments(EasyCL *cl) :
    ...
    "\n"
    "";
    kernel = cl->buildKernelFromString("ReduceSegments", kernelSource, "reduce_segments", options, "cl/reduce_segments.cl");
    // [[[end]]]
