...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/conv/Im2Col.cpp: ~Im2Col");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/conv/Im2Col.cpp: setupBuilder");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/conv/Im2Col.cpp: buildKernelIm2Col");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/conv/Im2Col.cpp: buildKernelCol2Im");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/conv/Im2Col.cpp: col2Im");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/conv/Im2Col.cpp: string Im2Col::getKernelTemplate");
#endif
