...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/dropout/DropoutBackwardGpuNaive.cpp: ~DropoutBackwardGpuNaive");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/dropout/DropoutBackwardGpuNaive.cpp: npos) {");
#endif
...
//    cout << "inverseDropRatioString " << inverseDropRatioString << endl;
    ...
    "\n"
    "";
    kernel = cl->buildKernelFromString("DropoutBackwardGpuNaive", kernelSource, "backpropNaive", options, "cl/dropout.cl");
    // [[[end]]]
}
