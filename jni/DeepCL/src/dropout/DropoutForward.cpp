...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/dropout/DropoutForward.cpp: instance");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/dropout/DropoutForward.cpp: instanceForTest");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/dropout/DropoutForward.cpp: instanceSpecific");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/dropout/DropoutForward.cpp: forward");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/dropout/DropoutForward.cpp: getInputNumElements");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/dropout/DropoutForward.cpp: getOutputNumElements");
#endif
