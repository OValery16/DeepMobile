...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/dropout/DropoutForwardGpuNaive.cpp: ~DropoutForwardGpuNaive");
#endif
...
#if DEEPCL_VERBOSE == 1
LOGI( "DeepCL/src/dropout/DropoutForwardGpuNaive.cpp: forward");
#endif
...
//    options += " -D gInverseDropRatio=" + inverseDropRatioString;
    ...
    "\n"
    "";
    kernel = cl->buildKernelFromString("DropoutForwardGpuNaive", kernelSource, "forwardNaive", options, "cl/dropout.cl");
    // [[[end]]]
