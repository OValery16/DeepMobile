...
#include "DeepCL/src/weights/WeightsPersister.h"
...
//#include "DeepCL/test/gtest_supp.h"
//#include "DeepCL/test/Sampler.h"
//#include "DeepCL/test/TestArgsParser.h"
...
//        cout << "weightsSize, layer " << 1 << "= " << weightsSize << endl;
    ...
    stream << "weightsTotalSize=" << weightsTotalSize;
...
//        cout << "    actual loss change " << lossChange << endl;
        ...
        if(isnan(lossChange)) {
        	...
        	stream.str( "");
        	stream.clear();
        	stream << "    losschangefromw " << lossChangeFromW;
        	LOGI("%s",stream.str().c_str());
        	stream.str( "");
        	stream.clear();
        	stream << "    actual loss change " << lossChange;
        	LOGI("%s",stream.str().c_str());
        	stream.str( "");
        	stream.clear();
...
//            EXPECT_TRUE(!isnan(lossChange));
        ...
        if(lossChange / lossChangeFromW > tolerance) {
        	...
        	stream.str( "");
        	stream.clear();
        	stream << "    losschangefromw " << lossChangeFromW << endl;
        	LOGI("%s",stream.str().c_str());
        	stream.str( "");
        	stream.clear();
        	stream << "    actual loss change " << lossChange;
